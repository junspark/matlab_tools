...
%     'display', 'off', ...
%     'apply_ct', 0, ...
%     'pfname_ct', '/home/beams/PARKJS/matlab/matlab_tools/image-processing/pixirad2_mpe/sensitivity_map_Pb.mat', ...
%     'apply_bpt', 0, ...
%     'pfname_bpt', '/home/beams/PARKJS/matlab/matlab_tools/image-processing/pixirad2_mpe/bad_pixel_map_Pb.mat', ...
...
optcell = {...
    ...
    'display', 'off', ...
    'apply_ct', 0, ...
    'pfname_ct', 'sensitivity_map_Pb.mat', ...
    'apply_bpt', 0, ...
    'pfname_bpt', 'bad_pixel_map_Pb.mat', ...
    'apply_gaussian_filter', 0, ...
    'gaussian_filter_sigma', 2, ...
    };
