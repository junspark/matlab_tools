    ...
    if nosteps==0
        ...
        for j = 1:nosteps
            ...
            switch edd(i).motorname
                ...
                case 'roty'
                    edd(i).motorpos(j) = h3data(4);
                case 'ksamx'
                    edd(i).motorpos(j) = h3data(5);
                case 'ksamz'
                    edd(i).motorpos(j) = h3data(6);
                case 'ksamrx'
                    edd(i).motorpos(j) = h3data(7);
                case 'ksamrz'
                    edd(i).motorpos(j) = h3data(8);
                otherwise
