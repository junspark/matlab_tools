...
%            (3-D)   'tets:4', 'tets:10', 'bricks:8'
%
%   OUTPUT:
%
%   NOTES:
%
%   * Standard ordering of all elements is dictionary(z, y, x)
...
switch tname
 ...
 case 'tets:4'
  ...
  elsurfs  = [1 2 3; 1 4 2; 1 3 4; 2 4 3]';
 case 'tets:10'  % femevps
  dimension      = 3;
  is_rectangular = 0;
  is_simplicial  = 1;
  surftype = 'triangles:6';
  elsurfs  = [1 2 3 4 5 6; 1 7 10 2 8 3; 1 4 6 7 9 10; 3 8 10 5 9 6]';
 case 'bricks:8'  
  dimension      = 3;
  is_rectangular = 1;
  is_simplicial  = 0;
