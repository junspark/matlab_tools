function outvec = MillerBravaisToUnit(invec, aspect)
% MILLERBRAVAISTOUNIT - Generate the unit vector(s) for a direction(s) given in
...
%   Usage:
%
%       outvec = MillerBravaisToUnit(invec)
%
%   Inputs:
%
