...
% %%% INPUT PARAMETERS - WHEEL A
XRDIMAGE.DarkField.pname    = '~/mnt/s1c/park_jul16/ge';
XRDIMAGE.DarkField.fbase    = 'dark_0pt5s_';
XRDIMAGE.DarkField.fnumber  = 557;
XRDIMAGE.DarkField.numframe = 5;
XRDIMAGE.DarkField.numdigs  = 5;
XRDIMAGE.DarkField.fext     = 'ge1';

XRDIMAGE.Image.pname        = '~/mnt/s1c/park_jul16/ge';
XRDIMAGE.Image.fbase        = 'wheelA_';
XRDIMAGE.Image.fnumber      = 125:268;
...
XRDIMAGE.Calib.pname        = '~/mnt/s1c/park_jul16/ge';
XRDIMAGE.Calib.fbase        = 'wheelA_';
XRDIMAGE.Calib.fnumber      = 125;
XRDIMAGE.Calib.fext         = 'ge1';

%%% INPUT PARAMETERS - WHEEL B
XRDIMAGE.DarkField.pname    = '~/mnt/s1c/park_jul16/ge';
XRDIMAGE.DarkField.fbase    = 'dark_0pt5s_';
XRDIMAGE.DarkField.fnumber  = 557;
XRDIMAGE.DarkField.numframe = 5;
...
XRDIMAGE.Image.pname        = '~/mnt/s1c/park_jul16/ge';
XRDIMAGE.Image.fbase        = 'wheelB_';
XRDIMAGE.Image.fnumber      = 269:412;
XRDIMAGE.Image.numframe     = 10;
XRDIMAGE.Image.numdigs      = 5;
XRDIMAGE.Image.fext         = 'ge1';
XRDIMAGE.Image.corrected    = 0;
...
XRDIMAGE.Image.pname        = '~/mnt/s1c/park_jul16/ge';
XRDIMAGE.Image.fbase        = 'wheelC_';
XRDIMAGE.Image.fnumber      = 413:556;
XRDIMAGE.Image.numframe     = 10;
XRDIMAGE.Image.numdigs      = 5;
XRDIMAGE.Image.fext         = 'ge1';
XRDIMAGE.Image.corrected    = 0;
...
fname_video = sprintf('%s%s.avi', XRDIMAGE.Image.fbase, XRDIMAGE.Image.fext);
...
if Analysis_Options.make_polimg
    figure(1)
    colormap jet
    f(numimg)   = struct('cdata', [], 'colormap', []);
    for i = 1:1:numimg
        disp('###########################')
        ...
        imagesc(log(abs(polimg.intensity_in_tth_grid)))
        axis square tight
        title(pfname{i,1}, 'interpreter', 'none');
        XTick       = get(ax, 'XTick');
        XTickLabel  = num2str(polimg.tth_grid(XTick)', '%10.2f');
        set(ax, 'XTickLabel',  XTickLabel)
        set(ax, 'YTickLabel',  num2str(XRDIMAGE.CakePrms.azim'))
        xlabel('2 \theta (deg)')
        ylabel('\eta (deg)')
        drawnow;
        ax.Units    = 'pixels';
    ...
    movie2avi(f, fname_video, 'compression', 'none');
end
