function m = step1_GeneratePolImg_swift(infile, outfile, fnumber)
if isstr(fnumber)
    fnumber = str2num(fnumber);
end
...
% %%% INPUT PARAMETERS
% % XRDIMAGE.Image.pname        = '/clhome/TOMO1/tomo/park_swift/step1_GeneratePolImg/bin';
% XRDIMAGE.Image.pname        = 'O:\park_swift\step1_GeneratePolImg';
...
% % XRDIMAGE.DarkField.pname    = '/clhome/TOMO1/tomo/park_swift/step1_GeneratePolImg/bin';
% XRDIMAGE.DarkField.pname    = 'O:\park_swift\step1_GeneratePolImg';
...
% 
% % XRDIMAGE.Calib.pname        = '/clhome/TOMO1/tomo/park_swift/step1_GeneratePolImg/bin';
% XRDIMAGE.Calib.pname        = 'O:\park_swift\step1_GeneratePolImg';
...
%     'MaxIter', 5e5,...
%     'MaxFunEvals',3e5);
% save('./parameters_win.mat')
% return

%%% IMAGE NUMBERS TO INTEGRATE / BIN
XRDIMAGE.Image.fnumber      = fnumber; % 4116 / 4117
...
%%% INSTR PARAMETER FITTING OPTIONS
...
m   = [polimg.tth_grid; intensity_in_tth_grid];
dlmwrite(outfile, m);