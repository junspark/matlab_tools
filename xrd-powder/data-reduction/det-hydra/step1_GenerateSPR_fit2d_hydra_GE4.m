...
DataReductionPrms.DarkPath  = 'V:\__eval\stock_feb14_partial\CeO2';
DataReductionPrms.DarkName  = { ...
    'dark_00571.ge4'; ...
    };

%%% LOCATION AND NAME OF STRAIN IMAGES - PROVIDE A LIST OF IMAGE FILE NAMES
DataReductionPrms.ImagePath     = 'V:\__eval\stock_feb14_partial\CeO2';
fnum    = 570;
fstem   = 'CeO2_';
fext    = 'ge4';
...
DataReductionPrms.Dsam      = 2155.858;
DataReductionPrms.Energy    = 51.996;
DataReductionPrms.Lambda    = keV2Angstrom(DataReductionPrms.Energy);
DataReductionPrms.x0        = 2275.730;
DataReductionPrms.y0        = 2119.558;
DataReductionPrms.TiltPlane = -97.493;
DataReductionPrms.InPlane   = +0.657;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
