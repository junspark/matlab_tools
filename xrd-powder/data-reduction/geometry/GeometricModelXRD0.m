function mappedData = GeometricModelXRD0(centTrans, D, ...
    gammaYprime, gammaXhatPrime, ...
    data, azim)

% GeometricModelXRD0 - Apply geometric model and detector distortion to the
% raw 2theta fits
%
% USAGE:
%
...
for i = 1:numSpectra
    ...
    %% THIS DOES NOT CORRECT RADIAL COORDINATES
    rhoHatdPrime = data(:,i);
