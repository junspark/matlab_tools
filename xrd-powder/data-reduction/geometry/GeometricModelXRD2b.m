function mappedData = GeometricModelXRD2b(centTrans, D, ...
...
for i = 1:numSpectra
    ...
    %% PROPOSED BY Lee J.H.
    f = DistPars(1)*((data(:,i)/DistPars(7)).^(DistPars(4)))*cosd(DistPars(10)*azim(i)) ...
        + DistPars(2)*((data(:,i)/DistPars(8)).^(DistPars(5)))*cosd(DistPars(11)*azim(i)) ...
        + DistPars(3)*((data(:,i)/DistPars(9)).^DistPars(6)) ...
        + 1;
