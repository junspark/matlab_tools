...
XRDIMAGE.Instr.distance     = 1864.846726;     % mm
XRDIMAGE.Instr.centers      = [ -1.516302 , 1.910065 ]; % center offsets x & y (um)
XRDIMAGE.Instr.gammaX       = -0.027439;    % rad
XRDIMAGE.Instr.gammaY       = 0.002661;    % rad
