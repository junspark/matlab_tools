...
XRDIMAGE.Instr.distance     = 2726.994906;     % mm
XRDIMAGE.Instr.centers      = [ 1517.051023 , 47.259985 ]; % center offsets x & y (um)
XRDIMAGE.Instr.gammaX       = -0.002617;    % rad
XRDIMAGE.Instr.gammaY       = -0.000763;    % rad
...
XRDIMAGE.Instr.imrotation   = -27.5;
...
XRDIMAGE.CakePrms.origin(1) = 2297.003560;         % apparent X center in pixels // THIS IS WHAT YOU SEE ON FIGURE 1
XRDIMAGE.CakePrms.origin(2) = -89.883021;            % apparent Y center in pixels // THIS IS WHAT YOU SEE ON FIGURE 1
