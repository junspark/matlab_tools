...
XRDIMAGE.Instr.distance     = 2.6508e+03;     % mm
XRDIMAGE.Instr.centers      = [ 1.5148e+03 , 41.6595]; % center offsets x & y (um)
XRDIMAGE.Instr.gammaX       = 0.0017;    % rad
XRDIMAGE.Instr.gammaY       = -0.0026;    % rad
