...
DataReductionPrms.Dsam      = 2163.628;
DataReductionPrms.Energy    = 51.996;
DataReductionPrms.Lambda    = keV2Angstrom(DataReductionPrms.Energy);
DataReductionPrms.x0        = 2266.986;
DataReductionPrms.y0        = 2099.995;
DataReductionPrms.TiltPlane = -52.006;
DataReductionPrms.InPlane   = 0.132;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
