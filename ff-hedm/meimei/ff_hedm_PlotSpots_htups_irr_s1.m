...
pfdark      = '/home/beams/S1IDUSER/mnt/s1c/meimei_aug14/ge3/dark_02587.ge3';

pname_ome   = '/home/beams/S1IDUSER/mnt/orthros/li_aug14/hedm_HTUPS_irr_s1_MultiRing/Layer1_ring1_t150_ring2_t50_new_params2/Output';
grains      = load('/home/beams/S1IDUSER/mnt/orthros/li_aug14/hedm_HTUPS_irr_s1_MultiRing/Layer1_ring1_t150_ring2_t50_new_params2/Grains.csv');
pfimage{1}  = '/home/beams/S1IDUSER/mnt/s1c/meimei_aug14/ge3/hedm_HTUPS_irr_s1_02546.ge3';
pfimage{2}  = '/home/beams/S1IDUSER/mnt/s1c/meimei_aug14/ge3/hedm_HTUPS_irr_s1_02547.ge3';
pfimage{3}  = '/home/beams/S1IDUSER/mnt/s1c/meimei_aug14/ge3/hedm_HTUPS_irr_s1_02548.ge3';
pfname_output   = './hedm_HTUPS_irr_s1_MultiRing/Layer1_ring1_t150_ring2_t50_new_params2_SpotFits.csv';    %%% FIT OUTPUT

% pname_ome   = '/home/beams/S1IDUSER/mnt/orthros/li_aug14/hedm_HTUPS_irr_s1_MultiRing/Layer2_ring1_t150_ring2_t50_new_params2/Output';
% grains      = load('/home/beams/S1IDUSER/mnt/orthros/li_aug14/hedm_HTUPS_irr_s1_MultiRing/Layer2_ring1_t150_ring2_t50_new_params2/Grains.csv');
% pfimage{1}  = '/home/beams/S1IDUSER/mnt/s1c/meimei_aug14/ge3/hedm_HTUPS_irr_s1_02549.ge3';
% pfimage{2}  = '/home/beams/S1IDUSER/mnt/s1c/meimei_aug14/ge3/hedm_HTUPS_irr_s1_02550.ge3';
% pfimage{3}  = '/home/beams/S1IDUSER/mnt/s1c/meimei_aug14/ge3/hedm_HTUPS_irr_s1_02551.ge3';
% pfname_output   = './hedm_HTUPS_irr_s1_MultiRing/Layer2_ring1_t150_ring2_t50_new_params2_SpotFits.csv';    %%% FIT OUTPUT

% pname_ome   = '/home/beams/S1IDUSER/mnt/orthros/li_aug14/hedm_HTUPS_irr_s1_MultiRing/Layer3_ring1_t150_ring2_t50_new_params2/Output';
% grains      = load('/home/beams/S1IDUSER/mnt/orthros/li_aug14/hedm_HTUPS_irr_s1_MultiRing/Layer3_ring1_t150_ring2_t50_new_params2/Grains.csv');
% pfimage{1}  = '/home/beams/S1IDUSER/mnt/s1c/meimei_aug14/ge3/hedm_HTUPS_irr_s1_02552.ge3';
% pfimage{2}  = '/home/beams/S1IDUSER/mnt/s1c/meimei_aug14/ge3/hedm_HTUPS_irr_s1_02553.ge3';
% pfimage{3}  = '/home/beams/S1IDUSER/mnt/s1c/meimei_aug14/ge3/hedm_HTUPS_irr_s1_02554.ge3';
% pfname_output   = './hedm_HTUPS_irr_s1_MultiRing/Layer3_ring1_t150_ring2_t50_new_params2_SpotFits.csv';    %%% FIT OUTPUT
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     axis equal
    ...
    for j = 1:1:num_spots
        detX    = Spots.data(j,18)/200;
        detY    = Spots.data(j,19)/200;
        detX    = -detX + CENX;
        detY    = -detY + (2048 - CENY);
