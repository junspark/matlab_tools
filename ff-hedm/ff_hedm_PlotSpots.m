...
pfdarak     = '/home/beams/S1IDUSER/mnt/s1c/meimei_aug14/ge3/dark_02587.ge3';

pname_ome   = './hedm_HTUPS_irr_s1_MultiRing/Layer1_ring1_t150_ring2_t50/Output';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% ff_HEDM ANALYSIS RESULT
grains	= load('./hedm_HTUPS_irr_s1_MultiRing/Layer1_ring1_t150_ring2_t50/Grains.csv');
